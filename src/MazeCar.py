        ...
        for car in self.game_mode.car_info:
            game_progress["object_list"].append(
                create_image_view_data(car["image"], car["topleft"][0], car["topleft"][1], car["size"][0], car["size"][1],
                                       car["angle"]))
            # game_progress["object_list"].append(
            #     create_rect_view_data("car_rect", self.game_mode.car.rect.x, self.game_mode.car.rect.y,
            #                           self.game_mode.car.rect.width, self.game_mode.car.rect.height, RED, car["angle"]))
